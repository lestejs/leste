...
})({"7AwCR":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f9cc6813bba0791c";
...
},{}],"j4lAn":[function(require,module,exports) {
...
var _codemirrorDefault = parcelHelpers.interopDefault(_codemirror);
var _codemirrorCss = require("./codemirror.css");
var _javascriptJs = require("codemirror/mode/javascript/javascript.js");
var _iframeHtml = require("bundle-text:./iframe.html");
var _iframeHtmlDefault = parcelHelpers.interopDefault(_iframeHtml);
var _leste = require("~/leste");
var _lesteDefault = parcelHelpers.interopDefault(_leste);
var _indexTxt = require("bundle-text:../../examples/tuner/index.txt");
var _indexTxtDefault = parcelHelpers.interopDefault(_indexTxt);
var _teslaLogoPNGImagesHDPng = require("url:./sponsors/Tesla-Logo-PNG-Images-HD.png");
var _teslaLogoPNGImagesHDPngDefault = parcelHelpers.interopDefault(_teslaLogoPNGImagesHDPng);
exports.default = {
    fragments: {
        wrapper: `
    ...
    <div class="columns container">
      <div class="column">
        <div class="icon">${_icon.iconGenerate('0000000111111111110000000')}</div>
        <h2>Скорость</h2>
      ...
      <div class="column">
        <div class="icon">${_icon.iconGenerate('0000011110111101000000000')}</div>
        <h2>Независимость</h2>
      ...
      <div class="column">
        <div class="icon">${_icon.iconGenerate('0000011000111111100000000')}</div>
        <h2>Надежность</h2>
    ...
    <div class="footer container">
        ...
        <div class="titles">
          <a href="https://www.tesla.com/" class="title">
            <img src="${_teslaLogoPNGImagesHDPngDefault.default}" alt="tesla">
          </a>
        ...
        return {
            first: {
                component: {
                    ...
                    params: {
                        label: 'Get Started',
                        icon: _icon.iconGenerate('0000000111111111111100000')
                    }
                }
            },
            second: {
                component: {
                    ...
                    params: {
                        label: 'GitHub',
                        icon: _icon.iconGenerate('0100101111011111111000110')
                    }
                }
            },
            codeMenu: {
            ...
            iframe: {
                srcdoc: _iframeHtmlDefault.default
            }
        };
    },
    mounted () {
        this.node.iframe.onload = ()=>{
            this._editor = _codemirrorDefault.default(this.node.codeMenu, {
                lineNumbers: true,
                lineWrapping: true,
                indentWithTabs: false,
                tabSize: 2,
                value: _indexTxtDefault.default,
                mode: {
                    name: "javascript",
                    json: true,
                    statementIndent: 2
            ...
            this.node.iframe.contentWindow.mount = _lesteDefault.default;
...
},{"../../layouts/common":"lvaUR","~/ui/button":"8dzdf","~/ui/icon":"dcE2L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./index.pcss":"66HAn","codemirror":"2Peje","codemirror/mode/javascript/javascript.js":"6YWC8","bundle-text:./iframe.html":"xoYET","~/leste":"6PCD9","./codemirror.css":"akWif","bundle-text:../../examples/tuner/index.txt":"99Bgl","url:./sponsors/Tesla-Logo-PNG-Images-HD.png":"9rlHb"}],"lvaUR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:./leste.svg":"aoHVA","~/ui/button":"8dzdf","~/ui/icon":"dcE2L","~/ui/dropdown":"lcBYu","./menu.js":"7q7oY"}],"aoHVA":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('lrFCH') + "leste.d494ee96.svg" + "?" + Date.now();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"66HAn":[function() {},{}],"2Peje":[function(require,module,exports) {
(function(global, factory) {
    ...
    var range1;
    if (document.createRange) range1 = function(node, start, end, endNode) {
        var r = document.createRange();
        r.setEnd(endNode || node, end);
        r.setStart(node, start);
        return r;
    };
    else range1 = function(node, start, end) {
    ...
    var noHandlers = [];
    var on1 = function(emitter, type, f) {
    ...
    function hasBadBidiRects(measure) {
        ...
        var r0 = range1(txt, 0, 1).getBoundingClientRect();
        var r1 = range1(txt, 1, 2).getBoundingClientRect();
    ...
    function hasBadZoomedRects(measure) {
        ...
        var node = removeChildrenAndAdd(measure, elt1("span", "x"));
        var normal = node.getBoundingClientRect();
        var fromRange = range1(node, 0, 1).getBoundingClientRect();
    ...
    function getLineStyles(cm, line, updateFrontier) {
        if (!line.styles || line.styles[0] != cm.state.modeGen) {
            var context = getContextBefore(cm, lineNo1(line));
        ...
        if (!special.test(text)) {
            ...
            while(true){
                ...
                if (skipped) {
                    ...
                    if (ie && ie_version < 9) content.appendChild(elt1("span", [
                        txt
                    ]));
                ...
                if (m[0] == "\t") {
                    ...
                    txt$1 = content.appendChild(elt1("span", spaceStr(tabWidth), "cm-tab"));
                    txt$1.setAttribute("role", "presentation");
                    txt$1.setAttribute("cm-text", "\t");
                    builder.col += tabWidth;
                } else if (m[0] == "\r" || m[0] == "\n") {
                    txt$1 = content.appendChild(elt1("span", m[0] == "\r" ? "\u240d" : "\u2424", "cm-invalidchar"));
            ...
            if (nextChange == pos) {
                ...
                for(var j = 0; j < spans.length; ++j){
                    ...
                    if (m.type == "bookmark" && sp.from == pos && m.widgetNode) foundBookmarks.push(m);
                        ...
                        if (m.title) (attributes || (attributes = {
                        })).title = m.title;
                        if (m.attributes) for(var attr in m.attributes)(attributes || (attributes = {
    ...
    function LineView(doc, line, lineN) {
        ...
        this.size = this.rest ? lineNo1(lst(this.rest)) - lineN + 1 : 1;
    ...
    function ensureLineWrapped(lineView) {
        if (lineView.node == lineView.text) {
            lineView.node = elt1("div", null, null, "position: relative");
    ...
    function updateLineBackground(cm, lineView) {
        ...
        if (lineView.background) {
            ...
            lineView.background = wrap.insertBefore(elt1("div", null, cls), wrap.firstChild);
    ...
    function updateLineGutter(cm, lineView, lineN, dims) {
        ...
        if (lineView.line.gutterClass) {
            var wrap = ensureLineWrapped(lineView);
            lineView.gutterBackground = elt1("div", null, "CodeMirror-gutter-background " + lineView.line.gutterClass, "left: " + (cm.options.fixedGutter ? dims.fixedPos : -dims.gutterTotalWidth) + "px; width: " + dims.gutterTotalWidth + "px");
        ...
        if (cm.options.lineNumbers || markers) {
            ...
            var gutterWrap = lineView.gutter = elt1("div", null, "CodeMirror-gutter-wrapper", "left: " + (cm.options.fixedGutter ? dims.fixedPos : -dims.gutterTotalWidth) + "px");
            gutterWrap.setAttribute("aria-hidden", "true");
            cm.display.input.setUneditable(gutterWrap);
            wrap$1.insertBefore(gutterWrap, lineView.text);
            if (lineView.line.gutterClass) gutterWrap.className += " " + lineView.line.gutterClass;
            if (cm.options.lineNumbers && (!markers || !markers["CodeMirror-linenumbers"])) lineView.lineNumber = gutterWrap.appendChild(elt1("div", lineNumberFor(cm.options, lineN), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + dims.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + cm.display.lineNumInnerWidth + "px"));
            if (markers) for(var k = 0; k < cm.display.gutterSpecs.length; ++k){
                var id = cm.display.gutterSpecs[k].className, found = markers.hasOwnProperty(id) && markers[id];
                if (found) gutterWrap.appendChild(elt1("div", [
                    found
    ...
    function widgetHeight1(widget) {
        ...
        if (!contains(document.body, widget.node)) {
            ...
            removeChildrenAndAdd(cm.display.measure, elt1("div", [
                widget.node
            ], null, parentStyle));
        }
    ...
    function paddingH(display) {
        ...
        var e = removeChildrenAndAdd(display.measure, elt1("pre", "x", "CodeMirror-line-like"));
    ...
    function mapFromLineView(lineView, line, lineN) {
        ...
        if (lineView.rest) {
            ...
            for(var i$1 = 0; i$1 < lineView.rest.length; i$1++){
                if (lineNo1(lineView.rest[i$1]) > lineN) return {
    ...
    function measureCharInner(cm, prepared, ch, bias) {
        ...
        if (node.nodeType == 3) {
            for(var i$1 = 0; i$1 < 4; i$1++){
                ...
                else rect = getUsefulRect(range1(node, start, end).getClientRects(), bias);
    ...
    function widgetTopHeight(lineObj) {
        ...
        var height = 0;
        if (widgets) {
            for(var i = 0; i < widgets.length; ++i)if (widgets[i].above) height += widgetHeight1(widgets[i]);
        }
        return height;
    }
    ...
    function cursorCoords(cm, pos, context, lineObj, preparedMeasure, varHeight) {
        ...
        if (ch1 >= lineObj.text.length) {
            ch1 = lineObj.text.length;
            sticky = "before";
        } else if (ch1 <= 0) {
            ch1 = 0;
            sticky = "after";
        }
        if (!order) return get(sticky == "before" ? ch1 - 1 : ch1, sticky == "before");
        function getBidi(ch, partPos, invert) {
            var part = order[partPos], right = part.level == 1;
            return get(invert ? ch - 1 : ch, right != invert);
        }
        var partPos = getBidiPartAt(order, ch1, sticky);
        var other = bidiOther;
        var val = getBidi(ch1, partPos, sticky == "before");
        if (other != null) val.other = getBidi(ch1, other, sticky != "before");
        return val;
    }
    ...
    function coordsCharInner(cm, lineObj, lineNo, x, y) {
        ...
        if (boxAround) {
            ...
            if (!ltr && (ch2 == end || ch2 == begin)) ch2++;
            // To determine which side to associate with, get the box to the
            // left of the character and compare it's vertical position to the
            // coordinates
            sticky = ch2 == 0 ? "after" : ch2 == lineObj.text.length ? "before" : measureCharPrepared(cm, preparedMeasure, ch2 - (ltr ? 1 : 0)).bottom + widgetHeight <= y == ltr ? "after" : "before";
        ...
        return PosWithInfo(lineNo, ch2, sticky, outside, x - baseX);
    }
    function coordsBidiPart(cm, lineObj, lineNo, preparedMeasure, order, x, y) {
        ...
        var part1 = order[index];
        // If this isn't the first part, the part's start is also after
        // the coordinates, and the coordinates aren't on the same line as
        // that start, move one part back.
        if (index > 0) {
            var ltr1 = part1.level != 1;
            var start = cursorCoords(cm, Pos(lineNo, ltr1 ? part1.from : part1.to, ltr1 ? "after" : "before"), "line", lineObj, preparedMeasure);
            if (boxIsAfter(start, x, y, true) && start.top > y) part1 = order[index - 1];
        }
        return part1;
    }
    function coordsBidiPartWrapped(cm, lineObj, _lineNo, preparedMeasure, order, x, y) {
        ...
        var ref = wrappedLineExtent1(cm, lineObj, preparedMeasure, y);
        var begin = ref.begin;
        var end = ref.end;
    ...
    function textHeight(display) {
        ...
        if (measureText == null) {
            ...
            for(var i = 0; i < 49; ++i){
                ...
                measureText.appendChild(elt1("br"));
            }
            measureText.appendChild(document.createTextNode("x"));
        }
    ...
    function charWidth(display) {
        ...
        var anchor = elt1("span", "xxxxxxxxxx");
        var pre = elt1("pre", [
            anchor
    ...
    function drawSelectionCursor(cm, head, output) {
        ...
        var cursor = output.appendChild(elt1("div", "\u00a0", "CodeMirror-cursor"));
    ...
    function drawSelectionRange(cm, range, output) {
        ...
        function add(left, top, width, bottom) {
            ...
            fragment.appendChild(elt1("div", null, "CodeMirror-selected", "position: absolute; left: " + left + "px;\n                             top: " + top + "px; width: " + (width == null ? rightSide - left : width) + "px;\n                             height: " + (bottom - top) + "px"));
        }
    ...
    function renderGutters(display) {
        ...
        for(var i = 0; i < specs.length; ++i){
            ...
            var style = ref.style;
            var gElt = gutters.appendChild(elt1("div", null, "CodeMirror-gutter " + className));
    ...
    function Display(place, doc, input, options) {
        ...
        d.scrollbarFiller = elt1("div", null, "CodeMirror-scrollbar-filler");
        d.scrollbarFiller.setAttribute("cm-not-content", "true");
        // Covers bottom of gutter when coverGutterNextToScrollbar is on
        // and h scrollbar is present.
        d.gutterFiller = elt1("div", null, "CodeMirror-gutter-filler");
        d.gutterFiller.setAttribute("cm-not-content", "true");
        // Will contain the actual code, positioned to cover the viewport.
        d.lineDiv = eltP("div", null, "CodeMirror-code");
        // Elements are added to these to represent selection and cursors.
        d.selectionDiv = elt1("div", null, null, "position: relative; z-index: 1");
        d.cursorDiv = elt1("div", null, "CodeMirror-cursors");
        // A visibility: hidden element used to find the size of things.
        d.measure = elt1("div", null, "CodeMirror-measure");
        // When lines outside of the viewport are measured, they are drawn in this.
        d.lineMeasure = elt1("div", null, "CodeMirror-measure");
        ...
        d.heightForcer = elt1("div", null, null, "position: absolute; height: " + scrollerGap + "px; width: 1px;");
        // Will contain the gutters, if any.
        d.gutters = elt1("div", null, "CodeMirror-gutters");
        d.lineGutter = null;
    ...
    function updateDoc(doc, change, markedSpans, estimateHeight) {
        ...
        function linesFor(start, end) {
            var result = [];
            for(var i = start; i < end; ++i)result.push(new Line(text1[i], spansFor(i), estimateHeight));
            return result;
        }
        var from = change.from, to = change.to, text1 = change.text;
        var firstLine = getLine(doc, from.line), lastLine = getLine(doc, to.line);
        var lastText = lst(text1), lastSpans = spansFor(text1.length - 1), nlines = to.line - from.line;
        // Adjust the line structure
        if (change.full) {
            doc.insert(0, linesFor(0, text1.length));
            doc.remove(text1.length, doc.size - text1.length);
        } else if (isWholeLineUpdate(doc, change)) {
            // This is a whole-line replace. Treated specially to make
            // sure line objects move the way they are supposed to.
            var added = linesFor(0, text1.length - 1);
            update(lastLine, lastLine.text, lastSpans);
            if (nlines) doc.remove(from.line, nlines);
            if (added.length) doc.insert(from.line, added);
        } else if (firstLine == lastLine) {
            if (text1.length == 1) update(firstLine, firstLine.text.slice(0, from.ch) + lastText + firstLine.text.slice(to.ch), lastSpans);
            else {
                var added$1 = linesFor(1, text1.length - 1);
                added$1.push(new Line(lastText + firstLine.text.slice(to.ch), lastSpans, estimateHeight));
                update(firstLine, firstLine.text.slice(0, from.ch) + text1[0], spansFor(0));
                doc.insert(from.line + 1, added$1);
            }
        } else if (text1.length == 1) {
            update(firstLine, firstLine.text.slice(0, from.ch) + text1[0] + lastLine.text.slice(to.ch), spansFor(0));
            doc.remove(from.line + 1, nlines);
        } else {
            update(firstLine, firstLine.text.slice(0, from.ch) + text1[0], spansFor(0));
            update(lastLine, lastText + lastLine.text.slice(to.ch), lastSpans);
            var added$2 = linesFor(1, text1.length - 1);
    ...
    function makeChangeInner(doc3, change) {
        ...
        var rebased = [];
        linkedDocs(doc3, function(doc, sharedHist) {
    ...
    function makeChangeFromHistory(doc4, type, allowSelectionOnly) {
        var suppress = doc4.cm && doc4.cm.state.suppressEdits;
        if (suppress && !allowSelectionOnly) return;
        var hist = doc4.history, event, selAfter = doc4.sel;
        ...
        for(; i3 < source.length; i3++){
            event = source[i3];
            if (allowSelectionOnly ? event.ranges && !event.equals(doc4.sel) : !event.ranges) break;
        }
        if (i3 == source.length) return;
        hist.lastOrigin = hist.lastSelOrigin = null;
        for(;;){
            event = source.pop();
            if (event.ranges) {
                pushSelectionToHistory(event, dest);
                if (allowSelectionOnly && !event.equals(doc4.sel)) {
                    setSelection(doc4, event, {
                        clearRedo: false
                    });
                    return;
                }
        ...
        var filter = hasHandler(doc4, "beforeChange") || doc4.cm && hasHandler(doc4.cm, "beforeChange");
        var loop = function(i) {
            var change = event.changes[i];
            change.origin = type;
            if (filter && !filterChange(doc4, change, false)) {
                source.length = 0;
                return {
                };
            }
            antiChanges.push(historyChangeFromChange(doc4, change));
            var after = i ? computeSelAfterChange(doc4, change) : lst(source);
            makeChangeSingleDoc(doc4, change, after, mergeOldSpans(doc4, change));
            if (!i && doc4.cm) doc4.cm.scrollIntoView({
                from: change.from,
                to: changeEnd(change)
            });
            var rebased = [];
            // Propagate to the linked documents
            linkedDocs(doc4, function(doc, sharedHist) {
                if (!sharedHist && indexOf(rebased, doc.history) == -1) {
                    rebaseHist(doc.history, change);
                    rebased.push(doc.history);
                }
    ...
    function shiftDoc(doc, distance) {
        ...
        doc.first += distance;
        doc.sel = new Selection(map1(doc.sel.ranges, function(range) {
    ...
    function makeChangeSingleDocInEditor(cm, change, spans) {
        ...
        if (!cm.options.lineWrapping) {
            checkWidthStart = lineNo1(visualLine(getLine(doc, from.line)));
        ...
        updateDoc(doc, change, spans, estimateHeight1(cm));
        if (!cm.options.lineWrapping) {
    ...
    LineWidget.prototype.changed = function() {
        ...
        if (cm) runInOp(cm, function() {
            ...
            signalLater(cm, "lineWidgetChanged", cm, this$1, lineNo1(line));
        });
    };
    ...
    function addLineWidget(doc, handle, node, options) {
        ...
        changeLine(doc, handle, "widget", function(line) {
            ...
            if (cm && !lineIsHidden(doc, line)) {
                ...
                updateLineHeight(line, line.height + widgetHeight1(widget));
                if (aboveVisible) addToScrollTop(cm, widget.height);
                cm.curOp.forceUpdate = true;
            }
            return true;
        });
        if (cm) signalLater(cm, "lineWidgetAdded", cm, widget, typeof handle == "number" ? handle : lineNo1(handle));
        return widget;
    }
    // TEXTMARKERS
    ...
    TextMarker.prototype.clear = function() {
        ...
        for(var i = 0; i < this.lines.length; ++i){
            ...
            if (cm && !this.collapsed) regLineChange(cm, lineNo1(line), "text");
            else if (cm) {
                if (span.to != null) max = lineNo1(line);
                if (span.from != null) min = lineNo1(line);
            }
    ...
    TextMarker.prototype.find = function(side, lineObj) {
        ...
        for(var i = 0; i < this.lines.length; ++i){
            ...
            var span = getMarkedSpanFor(line.markedSpans, this);
            if (span.from != null) {
                from = Pos(lineObj ? line : lineNo1(line), span.from);
                if (side == -1) return from;
            }
            if (span.to != null) {
                to = Pos(lineObj ? line : lineNo1(line), span.to);
                if (side == 1) return to;
            }
        }
        return from && {
    ...
    TextMarker.prototype.changed = function() {
        ...
        if (!pos || !cm) return;
        runInOp(cm, function() {
            var line = pos.line, lineN = lineNo1(pos.line);
            var view = findViewForLine(cm, lineN);
            if (view) {
    ...
    function markText(doc, from, to, options, type) {
        ...
        if (marker.clearOnEnter) on1(marker, "beforeCursorEnter", function() {
            return marker.clear();
        });
        if (marker.readOnly) {
            seeReadOnlySpans();
    ...
    function markTextShared(doc5, from, to, options, type) {
        options = copyObj(options);
        options.shared = false;
        var markers = [
            markText(doc5, from, to, options, type)
        ], primary = markers[0];
        var widget = options.widgetNode;
        linkedDocs(doc5, function(doc) {
    ...
    Doc.prototype = createObj(BranchChunk.prototype, {
        ...
        extendSelectionsBy: docMethodOp(function(f, options) {
            var heads = map1(this.sel.ranges, f);
            extendSelections(this, clipPosArray(this, heads), options);
        }),
        ...
        setGutterMarker: docMethodOp(function(line1, gutterID, value) {
            return changeLine(this, line1, "gutter", function(line) {
        ...
        unlinkDoc: function(other) {
            if (other instanceof CodeMirror1) other = other.doc;
    ...
    function onDragOver(cm, e) {
        ...
        if (!cm.display.dragCursor) {
            cm.display.dragCursor = elt1("div", null, "CodeMirror-cursors CodeMirror-dragcursors");
    ...
    function forEachCodeMirror(f) {
        ...
        for(var i4 = 0; i4 < byClass.length; i4++){
            var cm = byClass[i4].CodeMirror;
    ...
    // Number keys
    for(var i1 = 0; i1 < 10; i1++)keyNames[i1 + 48] = keyNames[i1 + 96] = String(i1);
    // Alphabetic keys
    ...
    function normalizeKeyMap(keymap) {
        ...
        for(var keyname in keymap)if (keymap.hasOwnProperty(keyname)) {
            ...
            var keys = map1(keyname.split(" "), normalizeKeyName);
    ...
    function deleteNearSelection(cm, compute) {
        ...
        // ranges.
        for(var i5 = 0; i5 < ranges.length; i5++){
            var toKill = compute(ranges[i5]);
        ...
        if (visually) {
            ...
            if (order) {
                ...
                if (part.level > 0 || cm.doc.direction == "rtl") {
                    ...
                    ch3 = dir < 0 ? lineObj.text.length - 1 : 0;
                    var targetTop = measureCharPrepared(cm, prep, ch3).top;
                    ch3 = findFirst(function(ch) {
                        return measureCharPrepared(cm, prep, ch).top == targetTop;
                    }, dir < 0 == (part.level == 1) ? part.from : part.to - 1, ch3);
                    if (sticky == "before") ch3 = moveCharLogically(lineObj, ch3, 1);
    ...
    function moveVisually(cm, line, start, dir1) {
        var bidi = getOrder(line, cm.doc.direction);
        if (!bidi) return moveLogically(line, start, dir1);
        ...
        var partPos1 = getBidiPartAt(bidi, start.ch, start.sticky), part2 = bidi[partPos1];
        if (cm.doc.direction == "ltr" && part2.level % 2 == 0 && (dir1 > 0 ? part2.to > start.ch : part2.from < start.ch)) // Case 1: We move within an ltr part in an ltr editor. Even with wrapped lines,
        // nothing interesting happens.
        return moveLogically(line, start, dir1);
        ...
        if (cm.doc.direction == "rtl" || part2.level == 1) {
            var moveInStorageOrder = part2.level == 1 == dir1 < 0;
            var ch6 = mv(start, moveInStorageOrder ? 1 : -1);
            if (ch6 != null && (!moveInStorageOrder ? ch6 >= part2.from && ch6 >= wrappedLineExtent2.begin : ch6 <= part2.to && ch6 <= wrappedLineExtent2.end)) {
        ...
        var searchInVisualLine = function(partPos, dir, wrappedLineExtent) {
            ...
            for(; partPos >= 0 && partPos < bidi.length; partPos += dir){
                ...
                var moveInStorageOrder1 = dir > 0 == (part.level != 1);
                var ch7 = moveInStorageOrder1 ? wrappedLineExtent.begin : mv(wrappedLineExtent.end, -1);
                if (part.from <= ch7 && ch7 < part.to) return getRes(ch7, moveInStorageOrder1);
                ch7 = moveInStorageOrder1 ? part.from : mv(part.to, -1);
                if (wrappedLineExtent.begin <= ch7 && ch7 < wrappedLineExtent.end) return getRes(ch7, moveInStorageOrder1);
            }
        };
        // Case 3a: Look for other bidi parts on the same visual line
        var res = searchInVisualLine(partPos1 + dir1, dir1, wrappedLineExtent2);
        if (res) return res;
        // Case 3b: Look for other bidi parts on the next visual line
        var nextCh = dir1 > 0 ? wrappedLineExtent2.end : mv(wrappedLineExtent2.begin, -1);
        if (nextCh != null && !(dir1 > 0 && nextCh == line.text.length)) {
            res = searchInVisualLine(dir1 > 0 ? 0 : bidi.length - 1, dir1, getWrappedLineExtent(nextCh));
            if (res) return res;
        }
    ...
    function lineStart(cm, lineN) {
        ...
        if (visual != line) lineN = lineNo1(visual);
    ...
    function showCrossHair(cm) {
        ...
        function up(e) {
            if (e.keyCode == 18 || !e.altKey) {
                ...
                off1(document, "keyup", up);
                off1(document, "mouseover", up);
            }
        }
        on1(document, "keyup", up);
        on1(document, "mouseover", up);
    }
    function onKeyUp(e) {
    ...
    function leftButtonStartDrag(cm, event, pos, behavior) {
        ...
        var dragEnd = operation(cm, function(e) {
            ...
            off1(display.wrapper.ownerDocument, "mouseup", dragEnd);
            off1(display.wrapper.ownerDocument, "mousemove", mouseMove);
            off1(display.scroller, "dragstart", dragStart);
            off1(display.scroller, "drop", dragEnd);
            if (!moved) {
                e_preventDefault(e);
        ...
        on1(display.wrapper.ownerDocument, "mouseup", dragEnd);
        on1(display.wrapper.ownerDocument, "mousemove", mouseMove);
        on1(display.scroller, "dragstart", dragStart);
        on1(display.scroller, "drop", dragEnd);
        cm.state.delayingBlurEvent = true;
        setTimeout(function() {
            return display.input.focus();
        }, 20);
    ...
    function leftButtonSelect(cm, event, start, behavior) {
        ...
        if (behavior.addNew && !behavior.extend) {
            ...
            if (ourIndex > -1) ourRange = ranges1[ourIndex];
        ...
        if (!behavior.addNew) {
            ...
            ourIndex = ranges1.length;
            setSelection(doc, normalizeSelection(cm, ranges1.concat([
                ourRange
            ]), ourIndex), {
                scroll: false,
                origin: "*mouse"
            });
        } else if (ranges1.length > 1 && ranges1[ourIndex].empty() && behavior.unit == "char" && !behavior.extend) {
            setSelection(doc, normalizeSelection(cm, ranges1.slice(0, ourIndex).concat(ranges1.slice(ourIndex + 1)), 0), {
                scroll: false,
                origin: "*mouse"
            });
            startSel = doc.sel;
        ...
        function done(e) {
            ...
            off1(display.wrapper.ownerDocument, "mousemove", move);
            off1(display.wrapper.ownerDocument, "mouseup", up);
        ...
        on1(display.wrapper.ownerDocument, "mousemove", move);
        on1(display.wrapper.ownerDocument, "mouseup", up);
    }
    ...
    function CodeMirror1(place, options) {
        ...
        this.doc = doc;
        var input = new CodeMirror1.inputStyles[options.inputStyle](this);
        ...
        for(var opt in optionHandlers1)if (optionHandlers1.hasOwnProperty(opt)) optionHandlers1[opt](this, options[opt], Init);
    ...
    CodeMirror1.defaults = defaults;
    // Functions to run when options are changed.
    CodeMirror1.optionHandlers = optionHandlers1;
    // Attach the necessary event handlers when initializing the editor
    function registerEventHandlers(cm) {
        var d = cm.display;
        on1(d.scroller, "mousedown", operation(cm, onMouseDown));
        // Older IE's will not fire a second mousedown for a double click
        if (ie && ie_version < 11) on1(d.scroller, "dblclick", operation(cm, function(e) {
            if (signalDOMEvent(cm, e)) return;
            var pos = posFromMouse(cm, e);
        ...
        else on1(d.scroller, "dblclick", function(e) {
        ...
        on1(d.scroller, "touchstart", function(e) {
        ...
        on1(d.scroller, "touchcancel", finishTouch);
        // Sync scrolling between fake scrollbars and real scrollable
        // area, ensure viewport is updated when scrolling.
        on1(d.scroller, "scroll", function() {
        ...
        on1(inp, "keydown", operation(cm, onKeyDown));
        on1(inp, "keypress", operation(cm, onKeyPress));
        on1(inp, "focus", function(e) {
            return onFocus(cm, e);
        });
    ...
    function applyTextInput(cm, inserted, deleted, sel, origin) {
        ...
        if (paste && sel.ranges.length > 1) {
            ...
            } else if (textLines.length == sel.ranges.length && cm.options.pasteLinesPerSelection) multiPaste = map1(textLines, function(l) {
                return [
                    l
                ];
            });
    ...
    function hiddenTextarea() {
        var te = elt1("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; min-height: 1em; outline: none");
        var div = elt1("div", [
            te
    ...
    ContentEditableInput.prototype.init = function(display) {
        ...
        on1(div, "copy", onCopyCut);
        on1(div, "cut", onCopyCut);
    };
    ...
    ContentEditableInput.prototype.pollContent = function() {
        ...
        if (from.line == display.viewFrom || (fromIndex = findViewIndex(cm, from.line)) == 0) {
            fromLine = lineNo1(display.view[0].line);
            fromNode = display.view[0].node;
        } else {
            fromLine = lineNo1(display.view[fromIndex].line);
        ...
        if (toIndex == display.view.length - 1) {
            ...
            toLine = lineNo1(display.view[toIndex + 1].line) - 1;
    ...
    function locateNodeInLineView(lineView, node, offset1) {
        ...
        if (!node || !contains(wrapper, node)) return badPos(Pos(lineNo1(lineView.line), 0), true);
        if (node == wrapper) {
            bad = true;
            node = wrapper.childNodes[offset1];
            offset1 = 0;
            if (!node) {
        ...
        var textNode1 = node.nodeType == 3 ? node : null, topNode1 = node;
        if (!textNode1 && node.childNodes.length == 1 && node.firstChild.nodeType == 3) {
            textNode1 = node.firstChild;
            if (offset1) offset1 = textNode1.nodeValue.length;
        }
        while(topNode1.parentNode != wrapper)topNode1 = topNode1.parentNode;
            ...
            for(var i = -1; i < (maps ? maps.length : 0); i++){
                ...
                for(var j = 0; j < map.length; j += 3){
                    ...
                    if (curNode == textNode || curNode == topNode) {
                        var line = lineNo1(i < 0 ? lineView.line : lineView.rest[i]);
                        var ch = map[j] + offset;
    ...
    TextareaInput.prototype.init = function(display) {
        ...
        on1(te, "cut", prepareCopyCut);
        on1(te, "copy", prepareCopyCut);
        on1(display.scroller, "paste", function(e) {
    ...
    function fromTextArea(textarea, options) {
        ...
        function save() {
            textarea.value = cm1.getValue();
        }
        var realSubmit;
        if (textarea.form) {
            on1(textarea.form, "submit", save);
    ...
    // EDITOR CONSTRUCTOR
    defineOptions(CodeMirror1);
    addEditorMethods(CodeMirror1);
    // Set up methods on CodeMirror's prototype to redirect to the editor's document.
    var dontDelegate = "iter insert remove copy getEditor constructor".split(" ");
    for(var prop1 in Doc.prototype)if (Doc.prototype.hasOwnProperty(prop1) && indexOf(dontDelegate, prop1) < 0) CodeMirror1.prototype[prop1] = (function(method) {
        return function() {
            return method.apply(this.doc, arguments);
        };
    })(Doc.prototype[prop1]);
    eventMixin(Doc);
    CodeMirror1.inputStyles = {
    ...
    // used by (legacy) mechanisms like loadmode.js to automatically
    // load a mode. (Preferred mechanism is the require/define calls.)
    CodeMirror1.defineMode = function(name /*, mode, …*/ ) {
        if (!CodeMirror1.defaults.mode && name != "null") CodeMirror1.defaults.mode = name;
        defineMode.apply(this, arguments);
    };
    CodeMirror1.defineMIME = defineMIME;
    ...
    CodeMirror1.defineMIME("text/plain", "null");
    // EXTENSIONS
    CodeMirror1.defineExtension = function(name, func) {
...
(function(mod) {
    ...
    CodeMirror.defineMode("javascript", function(config, parserConfig) {
        ...
        function parseJS(state, style, type, content, stream) {
            ...
            while(true){
                ...
                if (combinator(type, content)) {
                    ...
                    if (cx1.marked) return cx1.marked;
        ...
        function pass() {
            for(var i = arguments.length - 1; i >= 0; i--)cx1.cc.push(arguments[i]);
        }
        function cont1() {
        ...
        function pushcontext() {
            cx1.state.context = new Context(cx1.state.context, cx1.state.localVars, false);
            cx1.state.localVars = defaultVars;
        }
        function pushblockcontext() {
            cx1.state.context = new Context(cx1.state.context, cx1.state.localVars, true);
            cx1.state.localVars = null;
        }
        pushcontext.lex = pushblockcontext.lex = true;
        function popcontext() {
            cx1.state.localVars = cx1.state.context.vars;
            cx1.state.context = cx1.state.context.prev;
        }
        popcontext.lex = true;
        function pushlex(type, info) {
            var result = function() {
                var state = cx1.state, indent = state.indented;
                if (state.lexical.type == "stat") indent = state.lexical.indented;
                else for(var outer = state.lexical; outer && outer.type == ")" && outer.align; outer = outer.prev)indent = outer.indented;
                state.lexical = new JSLexical(indent, cx1.stream.column(), type, null, state.lexical, info);
            };
            result.lex = true;
            return result;
        }
        ...
        function expect(wanted) {
            function exp(type) {
                if (type == wanted) return cont1();
                else if (wanted == ";" || type == "}" || type == ")" || type == "]") return pass();
                else return cont1(exp);
            }
            return exp;
        }
        function statement(type, value) {
            if (type == "var") return cont1(pushlex("vardef", value), vardef, expect(";"), poplex);
            if (type == "keyword a") return cont1(pushlex("form"), parenExpr, statement, poplex);
            if (type == "keyword b") return cont1(pushlex("form"), statement, poplex);
            if (type == "keyword d") return cx1.stream.match(/^\s*$/, false) ? cont1() : cont1(pushlex("stat"), maybeexpression, expect(";"), poplex);
            if (type == "debugger") return cont1(expect(";"));
            if (type == "{") return cont1(pushlex("}"), pushblockcontext, block1, poplex, popcontext);
            if (type == ";") return cont1();
            if (type == "if") {
                if (cx1.state.lexical.info == "else" && cx1.state.cc[cx1.state.cc.length - 1] == poplex) cx1.state.cc.pop()();
                return cont1(pushlex("form"), parenExpr, statement, poplex, maybeelse);
            }
            if (type == "function") return cont1(functiondef);
            if (type == "for") return cont1(pushlex("form"), pushblockcontext, forspec, statement, popcontext, poplex);
            if (type == "class" || isTS && value == "interface") {
                cx1.marked = "keyword";
                return cont1(pushlex("form", type == "class" ? type : value), className, poplex);
            }
            if (type == "variable") {
                if (isTS && value == "declare") {
                    cx1.marked = "keyword";
                    return cont1(statement);
                } else if (isTS && (value == "module" || value == "enum" || value == "type") && cx1.stream.match(/^\s*\w/, false)) {
                    cx1.marked = "keyword";
                    if (value == "enum") return cont1(enumdef);
                    else if (value == "type") return cont1(typename, expect("operator"), typeexpr, expect(";"));
                    else return cont1(pushlex("form"), pattern, expect("{"), pushlex("}"), block1, poplex, poplex);
                } else if (isTS && value == "namespace") {
                    cx1.marked = "keyword";
                    return cont1(pushlex("form"), expression, statement, poplex);
                } else if (isTS && value == "abstract") {
                    cx1.marked = "keyword";
                    return cont1(statement);
                } else return cont1(pushlex("stat"), maybelabel);
            }
            if (type == "switch") return cont1(pushlex("form"), parenExpr, expect("{"), pushlex("}", "switch"), pushblockcontext, block1, poplex, poplex, popcontext);
            if (type == "case") return cont1(expression, expect(":"));
            if (type == "default") return cont1(expect(":"));
            if (type == "catch") return cont1(pushlex("form"), pushcontext, maybeCatchBinding, statement, poplex, popcontext);
            if (type == "export") return cont1(pushlex("stat"), afterExport, poplex);
            if (type == "import") return cont1(pushlex("stat"), afterImport, poplex);
            if (type == "async") return cont1(statement);
            if (value == "@") return cont1(expression, statement);
            return pass(pushlex("stat"), expression, expect(";"), poplex);
        }
        function maybeCatchBinding(type) {
            if (type == "(") return cont1(funarg, expect(")"));
        }
        ...
        function parenExpr(type) {
            if (type != "(") return pass();
            return cont1(pushlex(")"), maybeexpression, expect(")"), poplex);
        }
        function expressionInner(type, value, noComma) {
            if (cx1.state.fatArrowAt == cx1.stream.start) {
                var body = noComma ? arrowBodyNoComma : arrowBody;
                if (type == "(") return cont1(pushcontext, pushlex(")"), commasep(funarg, ")"), poplex, expect("=>"), body, popcontext);
                else if (type == "variable") return pass(pushcontext, pattern, expect("=>"), body, popcontext);
            }
            var maybeop = noComma ? maybeoperatorNoComma : maybeoperatorComma;
            if (atomicTypes.hasOwnProperty(type)) return cont1(maybeop);
            if (type == "function") return cont1(functiondef, maybeop);
            if (type == "class" || isTS && value == "interface") {
                cx1.marked = "keyword";
                return cont1(pushlex("form"), classExpression, poplex);
            }
            if (type == "keyword c" || type == "async") return cont1(noComma ? expressionNoComma : expression);
            if (type == "(") return cont1(pushlex(")"), maybeexpression, expect(")"), poplex, maybeop);
            if (type == "operator" || type == "spread") return cont1(noComma ? expressionNoComma : expression);
            if (type == "[") return cont1(pushlex("]"), arrayLiteral, poplex, maybeop);
            if (type == "{") return contCommasep(objprop, "}", null, maybeop);
            if (type == "quasi") return pass(quasi, maybeop);
            if (type == "new") return cont1(maybeTarget(noComma));
            return cont1();
        }
        ...
        function maybeoperatorComma(type, value) {
            if (type == ",") return cont1(maybeexpression);
            return maybeoperatorNoComma(type, value, false);
        }
        function maybeoperatorNoComma(type, value, noComma) {
            var me = noComma == false ? maybeoperatorComma : maybeoperatorNoComma;
            var expr = noComma == false ? expression : expressionNoComma;
            if (type == "=>") return cont1(pushcontext, noComma ? arrowBodyNoComma : arrowBody, popcontext);
            if (type == "operator") {
                if (/\+\+|--/.test(value) || isTS && value == "!") return cont1(me);
                if (isTS && value == "<" && cx1.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, false)) return cont1(pushlex(">"), commasep(typeexpr, ">"), poplex, me);
                if (value == "?") return cont1(expression, expect(":"), expr);
                return cont1(expr);
            }
            if (type == "quasi") return pass(quasi, me);
            if (type == ";") return;
            if (type == "(") return contCommasep(expressionNoComma, ")", "call", me);
            if (type == ".") return cont1(property, me);
            if (type == "[") return cont1(pushlex("]"), maybeexpression, expect("]"), poplex, me);
            if (isTS && value == "as") {
                cx1.marked = "keyword";
                return cont1(typeexpr, me);
            }
            if (type == "regexp") {
                cx1.state.lastType = cx1.marked = "operator";
                cx1.stream.backUp(cx1.stream.pos - cx1.stream.start - 1);
                return cont1(expr);
            }
        }
        function quasi(type, value) {
            if (type != "quasi") return pass();
            if (value.slice(value.length - 2) != "${") return cont1(quasi);
            return cont1(maybeexpression, continueQuasi);
        }
        function continueQuasi(type) {
            if (type == "}") {
                cx1.marked = "string-2";
                cx1.state.tokenize = tokenQuasi;
                return cont1(quasi);
            }
        }
        function arrowBody(type) {
            findFatArrow(cx1.stream, cx1.state);
        ...
        function maybeTarget(noComma) {
            return function(type) {
                if (type == ".") return cont1(noComma ? targetNoComma : target);
                else if (type == "variable" && isTS) return cont1(maybeTypeArgs, noComma ? maybeoperatorNoComma : maybeoperatorComma);
        ...
        function target(_, value) {
            if (value == "target") {
                cx1.marked = "keyword";
                return cont1(maybeoperatorComma);
            }
        }
        function targetNoComma(_, value) {
            if (value == "target") {
                cx1.marked = "keyword";
                return cont1(maybeoperatorNoComma);
            }
        }
        function maybelabel(type) {
            if (type == ":") return cont1(poplex, statement);
        ...
        function objprop(type, value) {
            if (type == "async") {
                cx1.marked = "property";
                return cont1(objprop);
            } else if (type == "variable" || cx1.style == "keyword") {
                cx1.marked = "property";
                if (value == "get" || value == "set") return cont1(getterSetter);
                var m // Work around fat-arrow-detection complication for detecting typescript typed arrow params
                ;
                if (isTS && cx1.state.fatArrowAt == cx1.stream.start && (m = cx1.stream.match(/^\s*:\s*/, false))) cx1.state.fatArrowAt = cx1.stream.pos + m[0].length;
                return cont1(afterprop);
            } else if (type == "number" || type == "string") {
                cx1.marked = jsonldMode ? "property" : cx1.style + " property";
                return cont1(afterprop);
            } else if (type == "jsonld-keyword") return cont1(afterprop);
            else if (isTS && isModifier(value)) {
                cx1.marked = "keyword";
                return cont1(objprop);
            } else if (type == "[") return cont1(expression, maybetype, expect("]"), afterprop);
            else if (type == "spread") return cont1(expressionNoComma, afterprop);
            else if (value == "*") {
                cx1.marked = "keyword";
                return cont1(objprop);
        ...
        function getterSetter(type) {
            ...
            cx1.marked = "property";
            return cont1(functiondef);
        }
        function afterprop(type) {
            if (type == ":") return cont1(expressionNoComma);
            if (type == "(") return pass(functiondef);
        }
        function commasep(what, end, sep) {
            function proceed(type2, value1) {
                if (sep ? sep.indexOf(type2) > -1 : type2 == ",") {
                    var lex = cx1.state.lexical;
                    if (lex.info == "call") lex.pos = (lex.pos || 0) + 1;
                    return cont1(function(type, value) {
                        if (type == end || value == end) return pass();
                        return pass(what);
                    }, proceed);
                }
                if (type2 == end || value1 == end) return cont1();
                if (sep && sep.indexOf(";") > -1) return pass(what);
                return cont1(expect(end));
            }
            return function(type, value) {
                if (type == end || value == end) return cont1();
                return pass(what, proceed);
            };
        }
        function contCommasep(what, end, info) {
            for(var i = 3; i < arguments.length; i++)cx1.cc.push(arguments[i]);
            return cont1(pushlex(end, info), commasep(what, end), poplex);
        }
        function block1(type) {
            if (type == "}") return cont1();
            return pass(statement, block1);
        }
        function maybetype(type, value) {
            if (isTS) {
                if (type == ":") return cont1(typeexpr);
                if (value == "?") return cont1(maybetype);
            }
        }
        function maybetypeOrIn(type, value) {
            if (isTS && (type == ":" || value == "in")) return cont1(typeexpr);
        }
        function mayberettype(type) {
            if (isTS && type == ":") {
                if (cx1.stream.match(/^\s*\w+\s+is\b/, false)) return cont1(expression, isKW, typeexpr);
                else return cont1(typeexpr);
            }
        }
        ...
        function typeexpr(type, value) {
            if (value == "keyof" || value == "typeof" || value == "infer" || value == "readonly") {
                cx1.marked = "keyword";
                return cont1(value == "typeof" ? expressionNoComma : typeexpr);
            }
            if (type == "variable" || value == "void") {
                cx1.marked = "type";
                return cont1(afterType);
            }
            if (value == "|" || value == "&") return cont1(typeexpr);
            if (type == "string" || type == "number" || type == "atom") return cont1(afterType);
            if (type == "[") return cont1(pushlex("]"), commasep(typeexpr, "]", ","), poplex, afterType);
            if (type == "{") return cont1(pushlex("}"), typeprops, poplex, afterType);
            if (type == "(") return cont1(commasep(typearg, ")"), maybeReturnType, afterType);
            if (type == "<") return cont1(commasep(typeexpr, ">"), typeexpr);
        ...
        function typeprops(type) {
            if (type.match(/[\}\)\]]/)) return cont1();
            if (type == "," || type == ";") return cont1(typeprops);
            return pass(typeprop, typeprops);
        }
        function typeprop(type, value) {
            if (type == "variable" || cx1.style == "keyword") {
                cx1.marked = "property";
                return cont1(typeprop);
            } else if (value == "?" || type == "number" || type == "string") return cont1(typeprop);
            else if (type == ":") return cont1(typeexpr);
            else if (type == "[") return cont1(expect("variable"), maybetypeOrIn, expect("]"), typeprop);
            else if (type == "(") return pass(functiondecl, typeprop);
            else if (!type.match(/[;\}\)\],]/)) return cont1();
        }
        function quasiType(type, value) {
            if (type != "quasi") return pass();
            if (value.slice(value.length - 2) != "${") return cont1(quasiType);
            return cont1(typeexpr, continueQuasiType);
        }
        function continueQuasiType(type) {
            if (type == "}") {
                cx1.marked = "string-2";
                cx1.state.tokenize = tokenQuasi;
                return cont1(quasiType);
            }
        }
        function typearg(type, value) {
            if (type == "variable" && cx1.stream.match(/^\s*[?:]/, false) || value == "?") return cont1(typearg);
            if (type == ":") return cont1(typeexpr);
            if (type == "spread") return cont1(typearg);
            return pass(typeexpr);
        }
        function afterType(type, value) {
            if (value == "<") return cont1(pushlex(">"), commasep(typeexpr, ">"), poplex, afterType);
            if (value == "|" || type == "." || value == "&") return cont1(typeexpr);
            if (type == "[") return cont1(typeexpr, expect("]"), afterType);
            if (value == "extends" || value == "implements") {
                cx1.marked = "keyword";
                return cont1(typeexpr);
            }
            if (value == "?") return cont1(typeexpr, expect(":"), typeexpr);
        }
        ...
        function maybeTypeDefault(_, value) {
            if (value == "=") return cont1(typeexpr);
        }
        function vardef(_, value) {
            if (value == "enum") {
                cx1.marked = "keyword";
                return cont1(enumdef);
            }
        ...
        function pattern(type, value) {
            if (isTS && isModifier(value)) {
                cx1.marked = "keyword";
                return cont1(pattern);
            }
            if (type == "variable") {
                register(value);
                return cont1();
            }
            if (type == "spread") return cont1(pattern);
            if (type == "[") return contCommasep(eltpattern, "]");
            if (type == "{") return contCommasep(proppattern, "}");
        }
        function proppattern(type, value) {
            if (type == "variable" && !cx1.stream.match(/^\s*:/, false)) {
                register(value);
                return cont1(maybeAssign);
            }
            if (type == "variable") cx1.marked = "property";
            if (type == "spread") return cont1(pattern);
            if (type == "}") return pass();
            if (type == "[") return cont1(expression, expect(']'), expect(':'), proppattern);
            return cont1(expect(":"), pattern, maybeAssign);
        }
        function eltpattern() {
            return pass(pattern, maybeAssign);
        }
        function maybeAssign(_type, value) {
            if (value == "=") return cont1(expressionNoComma);
        }
        function vardefCont(type) {
            if (type == ",") return cont1(vardef);
        }
        function maybeelse(type, value) {
            if (type == "keyword b" && value == "else") return cont1(pushlex("form", "else"), statement, poplex);
        }
        function forspec(type, value) {
            if (value == "await") return cont1(forspec);
            if (type == "(") return cont1(pushlex(")"), forspec1, poplex);
        }
        function forspec1(type) {
            if (type == "var") return cont1(vardef, forspec2);
            if (type == "variable") return cont1(forspec2);
            return pass(forspec2);
        }
        function forspec2(type, value) {
            if (type == ")") return cont1();
            if (type == ";") return cont1(forspec2);
            if (value == "in" || value == "of") {
                cx1.marked = "keyword";
                return cont1(expression, forspec2);
            }
        ...
        function functiondef(type, value) {
            ...
            if (type == "(") return cont1(pushcontext, pushlex(")"), commasep(funarg, ")"), poplex, mayberettype, statement, popcontext);
            if (isTS && value == "<") return cont1(pushlex(">"), commasep(typeparam, ">"), poplex, functiondef);
        }
        function functiondecl(type, value) {
            if (value == "*") {
                cx1.marked = "keyword";
                return cont1(functiondecl);
            }
            if (type == "variable") {
                register(value);
                return cont1(functiondecl);
            }
            if (type == "(") return cont1(pushcontext, pushlex(")"), commasep(funarg, ")"), poplex, mayberettype, popcontext);
            if (isTS && value == "<") return cont1(pushlex(">"), commasep(typeparam, ">"), poplex, functiondecl);
        }
        function typename(type, value) {
            if (type == "keyword" || type == "variable") {
                cx1.marked = "type";
                return cont1(typename);
            } else if (value == "<") return cont1(pushlex(">"), commasep(typeparam, ">"), poplex);
        }
        function funarg(type, value) {
            if (value == "@") cont1(expression, funarg);
            if (type == "spread") return cont1(funarg);
            if (isTS && isModifier(value)) {
                cx1.marked = "keyword";
                return cont1(funarg);
            }
            if (isTS && type == "this") return cont1(maybetype, maybeAssign);
        ...
        function className(type, value) {
            if (type == "variable") {
                register(value);
                return cont1(classNameAfter);
            }
        }
        function classNameAfter(type, value) {
            if (value == "<") return cont1(pushlex(">"), commasep(typeparam, ">"), poplex, classNameAfter);
            if (value == "extends" || value == "implements" || isTS && type == ",") {
                if (value == "implements") cx1.marked = "keyword";
                return cont1(isTS ? typeexpr : expression, classNameAfter);
            }
            if (type == "{") return cont1(pushlex("}"), classBody, poplex);
        }
        function classBody(type, value) {
            if (type == "async" || type == "variable" && (value == "static" || value == "get" || value == "set" || isTS && isModifier(value)) && cx1.stream.match(/^\s+[\w$\xa1-\uffff]/, false)) {
                cx1.marked = "keyword";
                return cont1(classBody);
            }
            if (type == "variable" || cx1.style == "keyword") {
                cx1.marked = "property";
                return cont1(classfield, classBody);
            }
            if (type == "number" || type == "string") return cont1(classfield, classBody);
            if (type == "[") return cont1(expression, maybetype, expect("]"), classfield, classBody);
            if (value == "*") {
                cx1.marked = "keyword";
                return cont1(classBody);
            }
            if (isTS && type == "(") return pass(functiondecl, classBody);
            if (type == ";" || type == ",") return cont1(classBody);
            if (type == "}") return cont1();
            if (value == "@") return cont1(expression, classBody);
        }
        function classfield(type, value) {
            if (value == "!") return cont1(classfield);
            if (value == "?") return cont1(classfield);
            if (type == ":") return cont1(typeexpr, maybeAssign);
            if (value == "=") return cont1(expressionNoComma);
            var context = cx1.state.lexical.prev, isInterface = context && context.info == "interface";
            return pass(isInterface ? functiondecl : functiondef);
        }
        function afterExport(type, value) {
            if (value == "*") {
                cx1.marked = "keyword";
                return cont1(maybeFrom, expect(";"));
            }
            if (value == "default") {
                cx1.marked = "keyword";
                return cont1(expression, expect(";"));
            }
            if (type == "{") return cont1(commasep(exportField, "}"), maybeFrom, expect(";"));
            return pass(statement);
        }
        function exportField(type, value) {
            if (value == "as") {
                cx1.marked = "keyword";
                return cont1(expect("variable"));
            }
            if (type == "variable") return pass(expressionNoComma, exportField);
        }
        function afterImport(type) {
            if (type == "string") return cont1();
        ...
        function importSpec(type, value) {
            ...
            if (value == "*") cx1.marked = "keyword";
            return cont1(maybeAs);
        }
        function maybeMoreImports(type) {
            if (type == ",") return cont1(importSpec, maybeMoreImports);
        }
        function maybeAs(_type, value) {
            if (value == "as") {
                cx1.marked = "keyword";
                return cont1(importSpec);
            }
        }
        function maybeFrom(_type, value) {
            if (value == "from") {
                cx1.marked = "keyword";
                return cont1(expression);
            }
        }
        ...
        return {
            ...
            token: function(stream, state) {
                ...
                if (type1 == "comment") return style;
                state.lastType = type1 == "operator" && (content1 == "++" || content1 == "--") ? "incdec" : type1;
                return parseJS(state, style, type1, content1, stream);
            },
...
},{"../../lib/codemirror":"2Peje"}],"xoYET":[function(require,module,exports) {
module.exports = "<!DOCTYPE html>\n<html>\n    <head>\n        <meta charset=\"utf-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <div id=\"root\"></div>\n    <script src=\"/iframe.3b355686.js\"></script></body>\n</html>";

},{}],"akWif":[function() {},{}],"99Bgl":[function(require,module,exports) {
module.exports = "const component = {\n  template: `\n      <button class=\"prev\">prev</button>\n      <span class=\"index\"></span>\n      <button class=\"next\">next</button>`,\n  proxies: { index: 0 },\n  params: { max: 5 },\n  nodes() {\n    return {\n      index: {\n        textContent: () => this.proxy.index\n      },\n      prev: {\n        onclick: () =>  this.proxy.index--,\n        disabled: () => this.proxy.index === 0\n      },\n      next: {\n        onclick: () => this.proxy.index++,\n        disabled: () => this.proxy.index === this.param.max\n      }\n    }\n  }\n}\n\nconst root = document.querySelector('#root')\nmount(root, component)";

},{}],"9rlHb":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('lrFCH') + "Tesla-Logo-PNG-Images-HD.a65fd267.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["7AwCR"], null, "parcelRequirefcd5")

//# sourceMappingURL=home.bba0791c.js.map
